        ...
        "./node_modules/ngx-infinite-scroll/modules/ngx-infinite-scroll.es5.js":
            ...
            (function(module, __webpack_exports__, __webpack_require__) {
                ...
                function createResolver(_a) {
                    var windowElement = _a.windowElement,
                        axis = _a.axis;
                ...
                function calculatePointsForWindow(height, element, resolver) {
                    ...
                    var _a = extractHeightPropKeys(axis),
                        offsetHeightKey = _a.offsetHeightKey,
                        clientHeightKey = _a.clientHeightKey;
                ...
                function extractHeightForElement(_a) {
                    var container = _a.container,
                        isWindow = _a.isWindow,
                        axis = _a.axis;
                    var _b = extractHeightPropKeys(axis),
                        offsetHeightKey = _b.offsetHeightKey,
                        clientHeightKey = _b.clientHeightKey;
                ...
                function toInfiniteScrollParams(lastScrollPosition, stats, distance) {
                    var _a = getScrollStats(lastScrollPosition, stats, distance),
                        scrollDown = _a.scrollDown,
                        fire = _a.fire;
                    return {
                        scrollDown: scrollDown,
                ...
                var InfiniteScrollDirective = /** @class */ (function() {
                    ...
                    InfiniteScrollDirective.prototype.ngOnChanges = function(_a) {
                        var infiniteScrollContainer = _a.infiniteScrollContainer,
                            infiniteScrollDisabled = _a.infiniteScrollDisabled,
                            infiniteScrollDistance = _a.infiniteScrollDistance;
                        /** @type {?} */
